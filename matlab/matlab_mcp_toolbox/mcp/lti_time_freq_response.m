...
imp = [1 zeros(1,N-1)];   % unit impulse input
stp = ones(1,N);           % unit step input
...
%             y(n) = x(n) - x(n-1)
% =========================================================
figure('Name','First Order - System 1a','NumberTitle','off');
...
%             y(n) = 0.2x(n) + 0.2x(n-1) + 0.6y(n-1)
% =========================================================
figure('Name','First Order - System 1b','NumberTitle','off');
...
%             y(n) = 0.5x(n) + 0.9x(n-2) - 0.4y(n-2)
% =========================================================
figure('Name','Second Order - System 2a','NumberTitle','off');
...
sgtitle('Second Order System 2a :  y(n) = 0.5x(n) + 0.9x(n-2) - 0.4y(n-2)', ...
        'FontWeight','bold','FontSize',10);

% =========================================================
%  FIGURE 4 : Second Order System 2b
%             y(n) = x(n) + 0.9x(n-2) - 0.4y(n-2)
% =========================================================
figure('Name','Second Order - System 2b','NumberTitle','off');
